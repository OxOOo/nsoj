class User < ActiveRecord::Base
	...
	has_many :solved, ->{where(score: 100).group(:statistic_id).having("submission_score=max(submission_score)")}, class_name: "Submission", through: :user_course_ships
	has_many :accepted, class_name: "Submission", through: :user_course_ships, source: :accepted
	has_many :submissions, class_name: "Submission", through: :user_course_ships
